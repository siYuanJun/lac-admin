...
use App\Http\Model\Zstud_price_log;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class StudPriceLogController extends AdminController
{
    ...
    {
        $grid = new Grid(new Zstud_price_log);
        $grid->disableExport();
        $grid->disableActions();
        $grid->disableCreateButton();
        if($this->studUser()) {
            $grid->model()->where('uid', '=', $this->studUser()->id);
        }
    ...
    {
        $show = new Show(Zstud_price_log::findOrFail($id));
    ...
    {
        $form = new Form(new Zstud_price_log);
